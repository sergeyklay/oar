...
Output schema: Structured template containing modification classification, characteristic analysis tables, ranked rewrite candidates with assumption matrices. Ranked rewrite candidates should be formatted as follows:
...
[a list of assumptions made to complete the task, with salience/plausibility metrics]
</template>

Output Destination: Directly in user chat window.
