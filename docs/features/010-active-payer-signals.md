...
- **Related:** [Overview Screen](./005-overview-screen.md), [Logging Payments](./002-auto-pay.md), [Background Jobs](./006-background-jobs.md)
...
3. **Intentional Friction:** The "Log Payment" flow requires a few extra clicks compared to a simple "Checkmark" to ensure you actually look at the amount and date.
